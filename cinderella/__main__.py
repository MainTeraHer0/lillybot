...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://rkprojects)
⚡You Can Clone Me [Here](https://rkprojects)
"""
...
def send_start(bot, update):
    ...
    keyboard =  [[inlineKeyboardButton(text="➕add me to a Group ➕",=url="t.me/http://t.me/{}?startgroup=true".format(bot.username))]]
    keyboard += [[InlineKeyboardButton(text="🤝Help",callback_data="help_back"),InlineKeyboardButton(text="🔧Support",url="https://t.me/LillySupports")]]
    keyboard += [[InlineKeyboardButton(text="👥Group",=url="t.me/LillySupport"),InlineKeyboardButton(text="📢Channel",url="t.me/rkprojects")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Where do want to open the settings menu?",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="👤open in private chat",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="👥Support Group",url="https://t.me/LillySupport")]]))
        return
